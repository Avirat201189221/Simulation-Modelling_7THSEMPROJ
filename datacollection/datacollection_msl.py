...
folder="data/MSL/"
print("Begin MSL data collection")
for i in range(100):
    print("------------------------------------------------------------------------")
count=0
while(True):
    ...
    if (key == ord("a") ):
        ...
        count+=1
        cv2.imwrite(f'{folder}F/{str(count)}.jpg',whiteimg)
        print(count)
        ...
        count+=1
        cv2.imwrite(f'{folder}Ñ/{str(count)}.jpg',whiteimg)
        print(count)

    elif (key == ord("2") ):
        count+=1
        cv2.imwrite(f'{folder}RR/{str(count)}.jpg',whiteimg)
        print(count)

    elif (key == ord("3") ):
        count+=1
        cv2.imwrite(f'{folder}LL/{str(count)}.jpg',whiteimg)
        print(count)